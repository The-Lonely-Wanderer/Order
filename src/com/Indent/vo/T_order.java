...
public class T_order {
	...
	public String toString() {
		return "T_order [id=" + id + ", t_food=" + t_food + ", t_shopp=" + t_shopp + ", t_user=" + t_user
				+ ", username=" + username + ", prices=" + prices + ", foodname=" + foodname + ", price=" + price
				+ ", status=" + status + ", createTime=" + createTime + ", userId=" + userId + "]";
	}

	public T_order(String id, T_food t_food, List<T_shopp> t_shopp, T_user t_user, String username, Double prices,
			String foodname, Double price, String status, Date createTime, String userId) {
		super();
		this.id = id;
		this.t_food = t_food;
		this.t_shopp = t_shopp;
