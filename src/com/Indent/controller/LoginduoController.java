...
//		out.close();
	...
	// 冯雄飞
		...
		//登录
			...
			public String userlogin(@ModelAttribute("user")T_user t_user, Model model,HttpServletRequest request, HttpServletResponse response) {
				...
				if (null == t_user.getUsername() || "".equals(t_user.getUsername()) || null == t_user.getPassword() || "".equals(t_user.getPassword())) {
		...
		public String updateuser(HttpServletRequest request,HttpServletResponse response,Model model) throws UnsupportedEncodingException{
			request.setCharacterEncoding("utf-8");
			response.setCharacterEncoding("utf-8");	
