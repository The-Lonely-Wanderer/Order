 ...
 * 使用alert()方法要引用$和Dom.js 和弹出层的CSS(/css/v13/mode/alert.css)
 */
	...
	loginBox: function() {
		...
		base.alert({
			...
			alertCallback: function() {
				...
				var relEmali = /^([a-zA-Z0-9_]+[\.a-zA-Z0-9_-]*){1,}@([a-zA-Z0-9-]+\.){1,}[A-Za-z0-9]{2,4}$/
