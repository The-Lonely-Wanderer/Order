			...
			<div class="content-tab">
				...
				<div id="xg-admin" class="easyui-dialog" modal="true"
					...
					<form id="xg-adminform" action="addfood.action" method="POST" enctype="multipart/form-data">
						...
						<div class="w-index">
							<label class="w-label-1">菜品种类：</label><select id="catelog_id"
								name="catelog_id" style="width: 200px"></select>
						</div>
						<div class="w-index">
							<label class="w-label-1">图片：</label><input type="file"
...
// 							catelogId:,
	...
	$("#xg-but").click(
			function() {
				if ($("#foodname1").val().length == 0
						|| $("#catelog_id").val().length == 0
						|| $("#food_message1").val().length == 0
